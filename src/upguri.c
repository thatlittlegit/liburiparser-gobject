...
/**
 * upg_hierarchy_flags_get_type:
 *
 * Returns the #GType corresponding to #UpgHierarchyFlags, setting it up if
 * necessary.
 *
 * Returns: the #GType
 */
...
{
    // mostly generated by glib-mkenums, copied here
    ...
    if (g_once_init_enter(&gtype_id)) {
        GType new_type = g_enum_register_static(g_intern_static_string("UpgHierarchyFlags"), values);
